...
![image-20230208163025720](http://sm.cubxxw.com/sm202302081630890.png)
...
我们在 [docker ](https://docker.cubxxw.com) 中了解到，用户名称空间是分隔容器的一个很好的特性。**用户命名空间允许指定用户标识符（UID）和组标识符（GID）映射以运行容器。**
