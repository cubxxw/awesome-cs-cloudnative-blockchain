...
![image-20230216201601399](http://sm.cubxxw.com/sm202302162016460.png)
...
![image-20230216201803996](http://sm.cubxxw.com/sm202302162018046.png)
...
![image-20230216204817373](http://sm.cubxxw.com/sm202302162048445.png)
...
![image-20230216210737375](http://sm.cubxxw.com/sm202302162107454.png)

你可能还看过这么一种版本号：`v1.2.3-alpha`。这其实是把先行版本号（Pre-release）和版本编译元数据，作为延伸加到了主版本号。次版本号.修订号的后面，格式为 `X.Y.Z[-先行版本号][+版本编译元数据]`，如下图所示：

![image-20230216210806930](http://sm.cubxxw.com/sm202302162108985.png)
...
![image-20230216213135207](http://sm.cubxxw.com/sm202302162131312.png)

有这么多 type，我们该如何确定一个 commit 所属的 type 呢？这里我们可以通过下面这张图来确定。

![image-20230216213207684](http://sm.cubxxw.com/sm202302162132745.png)
...
![image-20230216215218600](http://sm.cubxxw.com/sm202302162152678.png)
...
![image-20230216215246718](http://sm.cubxxw.com/sm202302162152795.png)
...
![image-20230216220652890](http://sm.cubxxw.com/sm202302162206948.png)

修改完成后执行:wq 保存，会跳转到一个新的交互页面，在该页面，我们可以编辑 Commit Message，编辑后的内容如下图所示：

![image-20230216220820024](http://sm.cubxxw.com/sm202302162208078.png)
...
![image-20230216221259985](http://sm.cubxxw.com/sm202302162213838.png)
...
2. 修改倒数第 3 次提交 commit 的 message。`git rebase -i 倒数第三次 hash`
   ...
   ![image-20230216221800182](http://sm.cubxxw.com/sm202302162218248.png)

   修改完成后执行:wq 保存，还会跳转到一个新的交互页面，如下图所示

   ![image-20230216221817875](http://sm.cubxxw.com/sm202302162218931.png)
...
![image-20230216221936012](http://sm.cubxxw.com/sm202302162219088.png)
