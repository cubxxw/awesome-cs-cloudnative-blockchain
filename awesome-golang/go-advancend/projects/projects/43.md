...
```yaml
name: Go Teston: [push, pull_request]jobs:  helloci-build:    name: Test with go    runs-on: [ubuntu-latest]    environment:      name: ci-environment    steps:      - name: use secrets        env:          super_secret: ${}
```
