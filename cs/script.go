 ...
 * @LastEditTime: 2022-08-11 17:23:20
 * @FilePath: \undefinedd:\文档\git\Block_Chain\cs\script.go
 * @Description:
 */
...
func main() {
	...
	for i := 1; i < 51; i++ {
		...
		write.WriteString("+ [author(Github)](https://github.com)\n")
		...
		write.WriteString("> ❤️💕💕CS自学指南,大学教育无论是深度还是广度都没有办法支撑我们的职业素养,这个板块算是自己在CS学习中额外补充和记录的。个人博客:[http://nsddd.top](http://nsddd.top/)\n")
		write.WriteString("---\n")
