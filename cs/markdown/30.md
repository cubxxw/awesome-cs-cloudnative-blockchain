...
![image-20221015154857287](http://sm.cubxxw.com/smimage-20221015154857287.png?xxw@cubxxw.com)



下载的文件改名为jq.exe，文件保存的目录添加到环境变量path中，或者可以放入chromedriver的文件夹(此文件夹之前已经设置在path中)，再次打开cmd，使用 `jq --version` 如果显示下图说明配置成功

![image-20221015155347133](http://sm.cubxxw.com/smimage-20221015155347133.png?xxw@cubxxw.com)
...
![image-20221015160322562](http://sm.cubxxw.com/smimage-20221015160322562.png?xxw@cubxxw.com)
