...
<h1 id="第22节-go语言程序设计黑皮书学习和补充" tabindex="-1"><a class="header-anchor" href="#第22节-go语言程序设计黑皮书学习和补充" aria-hidden="true">#</a> 第22节 Go语言程序设计黑皮书学习和补充</h1>
<ul>
<li><RouterLink to="/go-advancend/">回到目录</RouterLink></li>
<li><RouterLink to="/go-advancend/markdown/21.html">上一节</RouterLink></li>
</ul>
<blockquote>
...
<hr>
<p>[TOC]</p>
<h2 id="入门篇" tabindex="-1"><a class="header-anchor" href="#入门篇" aria-hidden="true">#</a> 入门篇</h2>
<ul>
<li>import 声明必须跟在 package 之后。</li>
<li>每一个语句后面换行符默认转化为 <code v-pre>;</code> 其中 x+y 这个表达式中，换行符在+后面，不可以在 + 前面。</li>
</ul>
<h2 id="end-链接" tabindex="-1"><a class="header-anchor" href="#end-链接" aria-hidden="true">#</a> END 链接</h2>
<ul>
<li><RouterLink to="/go-advancend/">回到目录</RouterLink></li>
<li><RouterLink to="/go-advancend/markdown/21.html">上一节</RouterLink></li>
<li><RouterLink to="/go-advancend/markdown/23.html">下一节</RouterLink></li>
</ul>
<hr>
<ul>
