...
func main() {
	...
	for i := 1; i < 51; i++ {
		...
		write.WriteString("> ❤️💕💕计算机网络--TCP/IP 学习。Myblog:[http://nsddd.top](http://nsddd.top/)\n")
		write.WriteString("---\n")
		...
		write.WriteString("---\n")
		write.WriteString("+ [参与贡献❤️💕💕](https://github.com/3293172751/CS_COURSE/blob/master/Git/git-contributor.md)\n")
		//Flush将缓存的文件真正写入到文件中
		write.Flush()
		a = a + 1
	}
