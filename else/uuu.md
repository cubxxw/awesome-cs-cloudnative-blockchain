...
##### 安全/渗透测试
 ...
 🔸 [**awesome-burp-extensions**](https://github.com/snoopysecurity/awesome-burp-extensions) - 令人惊叹的 Burp 扩展的精选列表。
 🔸 [**免费安全电子书**](https://github.com/Hack-with-Github/Free-Security-eBooks)- 免费安全和黑客电子书列表。
 🔸 [**黑客安全电子书**](https://github.com/yeahhub/Hacking-Security-Ebooks)- 前 100 名黑客与安全电子书。
 🔸 [**尊重隐私 - 尊重**](https://github.com/nikitavoloboev/privacy-respecting)隐私的服务和软件的精选列表。
 🔸 [**reverse-engineering**](https://github.com/wtsxDev/reverse-engineering) - 很棒的逆向工程资源列表。
 🔸 [**linux-re-101**](https://github.com/michalmalik/linux-re-101) - 用于 linux 逆向工程的资源集合。
 🔸 [**reverseengineering-reading-list**](https://github.com/onethawt/reverseengineering-reading-list) - 逆向工程文章、书籍和论文的列表。
 🔸 [**Awesome-WAF**](https://github.com/0xInfection/Awesome-WAF) - 很棒的 Web 应用防火墙 (WAF) 东西的精选列表。
 🔸 [**awesome-shodan-queries**](https://github.com/jakejarvis/awesome-shodan-queries) - 插入 shodan.io 的有趣、有趣和令人沮丧的搜索查询。
 🔸 [**RobotsDisallowed**](https://github.com/danielmiessler/RobotsDisallowed) - 最常见和最有趣的 robots.txt 禁止目录的精选列表。
 🔸 [**HackingNeuralNetworks**](https://github.com/Kayzaks/HackingNeuralNetworks) - 是一门关于开发和保护神经网络的小课程。
 🔸 [**通配符证书**](https://gist.github.com/joepie91/7e5cad8c0726fd6a5e90360a754fc568)- 为什么您可能不应该使用通配符证书。
 🔸 [**不要使用 VPN 服务**](https://gist.github.com/joepie91/5a9909939e6ce7d09e29)——这是每个第三方“VPN 提供商”所做的。
 🔸 [**awesome-yara**](https://github.com/InQuest/awesome-yara) - 很棒的 YARA 规则、工具和人员的精选列表。
 🔸 [**macOS-Security-and-Privacy-Guide**](https://github.com/drduh/macOS-Security-and-Privacy-Guide) - 保护和改善 macOS 隐私的指南。
 🔸 [**macos_security -macOS**](https://github.com/usnistgov/macos_security)安全合规项目。
 🔸 [**awesome-sec-talks**](https://github.com/PaulSec/awesome-sec-talks) - 是令人敬畏的安全谈话的收集列表。
 🔸 [**黑客**](https://github.com/k4m4/movies-for-hackers)电影 - 每个黑客和赛博朋克必须观看的电影列表。
 🔸 [**Cryptography_1**](https://github.com/danieldizzy/Cryptography_1) - 参加 Dan Boneh 教授斯坦福加密课程时使用的材料。
 🔸 [**Crypton**](https://github.com/ashutosh1206/Crypton) - 学习和练习进攻性和防御性密码学的图书馆。

##### 其他

 🔸 [**Cheatography**](https://www.cheatography.com/) - 超过 3,000 个免费备忘单、修订辅助工具和快速参考。
 🔸 [**awesome-static-analysis**](https://github.com/mre/awesome-static-analysis) - 适用于所有编程语言的静态分析工具。
 🔸 [**计算机科学**](https://github.com/ossu/computer-science)- 计算机科学免费自学教育的途径。
 🔸 [**事后分析**](https://github.com/danluu/post-mortems)- 事后分析（配置错误、硬件故障等）的集合。
 🔸 [**build-your-own-x**](https://github.com/danistefanovic/build-your-own-x) - 构建自己的（在此处插入技术）。
 🔸 [**Project-Based-Tutorials-in-C**](https://github.com/rby90/Project-Based-Tutorials-in-C) - 是 C 中基于项目的教程的精选列表。
 🔸 [**The-Documentation-Compendium**](https://github.com/kylelobo/The-Documentation-Compendium) - 各种 README 模板和编写高质量文档的技巧。
 🔸 [**awesome-python-applications**](https://github.com/mahmoud/awesome-python-applications) - 运行良好的免费软件，也恰好是开源 Python。
 🔸 [**awesome-public-datasets**](https://github.com/awesomedata/awesome-public-datasets) - 以主题为中心的总部开放数据集列表。
 🔸 [**machine-learning-algorithms**](https://github.com/Sahith02/machine-learning-algorithms) - 所有机器学习算法和概念的精选列表。

#### 博客/播客/视频  [[目录\]](https://github.com/trimstray/the-book-of-secret-knowledge#anger-table-of-contents)

##### 系统运营/开发运营

 🔸 [**Varnish for PHP 开发人员**](https://www.youtube.com/watch?v=nAFpkV5-vuI)- Mattias Geniar 非常有趣的 Varnish 演示。
 🔸 [**A Netflix Guide to Microservices**](https://www.youtube.com/watch?v=CZ3wIuvmHeM) - 谈论 Netflix 混乱而充满活力的微服务世界。

##### 开发者

 🔸 [**将 C 与机器语言**](https://www.youtube.com/watch?v=yOyaJXpAYZQ)进行比较 - 将一个简单的 C 应用程序与该程序的已编译机器代码进行比较。

##### 极客

 🔸 [**Brendan Gregg 的博客**](http://www.brendangregg.com/)- 是计算性能和云计算方面的行业专家。
 🔸 [**Gynvael “GynDream” Coldwind**](https://gynvael.coldwind.pl/) - 是 Google 的一名 IT 安全工程师。
 🔸 [**Michał "lcamt​​uf" Zalewski**](http://lcamtuf.coredump.cx/) - 白帽黑客，计算机安全专家。
 🔸 [**Mattias Geniar**](https://ma.ttias.be/) - 开发人员、系统管理员、博主、播客和演讲者。
 🔸 [**Nick Craver**](https://nickcraver.com/) - Stack Exchange 的软件开发人员和系统管理员。
 🔸 [**Scott Helme**](https://scotthelme.co.uk/) - securityheaders.com 和 report-uri.com 的安全研究员、演讲者和创始人。
 🔸 [**Brian Krebs**](https://krebsonsecurity.com/) - 华盛顿邮报，现在是一名独立调查记者。
 🔸 [**Bruce Schneier——**](https://www.schneier.com/)是国际知名的安全技术专家，被称为“安全大师”。
 🔸 [**Chrissy Morgan**](https://chrissymorgan.co.uk/) - 实践学习的倡导者，Chrissy 还参与了漏洞赏金计划。
 🔸 [**Andy Gill**](https://blog.zsec.uk/) - 本质上是一名黑客，是一名高级渗透测试员。
 🔸 [**Daniel Miessler**](https://danielmiessler.com/) - 网络安全专家和作家。
 🔸 [**Samy Kamkar**](https://samy.pl/) - 美国隐私和安全研究员、计算机黑客。
 🔸 [**Javvad Malik**](https://www.j4vv4d.com/) - AlienVault 的安全倡导者、博主活动发言人和行业评论员。
 🔸 [**Graham Cluley**](https://www.grahamcluley.com/) - 公众演说家和独立计算机安全分析师。
 🔸 [**Kacper Szurek**](https://security.szurek.pl/) - ESET 的检测工程师。
 🔸 [**Troy Hunt**](https://www.troyhunt.com/) - 以安全主题的公共教育和外展而闻名的网络安全专家。
 🔸 [**raymii.org**](https://raymii.org/s/index.html) - 专门构建高可用性云环境的系统管理员。
 🔸 [**Robert Penz**](https://robert.penz.name/) - IT 安全专家。

##### 极客博客

 🔸 [**Linux Audit**](https://linux-audit.com/) - Michael Boelen 撰写的关于审计、强化和合规性的 Linux 安全博客。
 🔸 [**Linux 安全专家**](https://linuxsecurity.expert/)- 培训、操作指南、清单、安全工具等。
 🔸 [**Grymoire**](http://www.grymoire.com/) - 为巫师收集有用的咒语，无论是计算机巫师、魔术师还是其他任何人。
 🔸 [**Secjuice**](https://www.secjuice.com/) - 是信息安全领域唯一的非营利、独立和志愿者主导的出版物。
 🔸 [**解密**](https://duo.com/decipher)- 提供信息和启发的安全新闻。

##### 极客供应商博客

 🔸 [**Tenable Podcast**](https://www.tenable.com/podcast) - 与 Cyber Exposure 等相关的对话和采访。
 🔸 [**Sophos**](https://nakedsecurity.sophos.com/) - 威胁新闻室，为您提供有关计算机安全问题的新闻、意见、建议和研究。
 🔸 [**Tripwire State of Security**](https://www.tripwire.com/state-of-security/) - 博客，介绍有关当前安全问题的最新消息、趋势和见解。
 🔸 [**Malwarebytes Labs 博客**](https://blog.malwarebytes.com/)- 安全博客旨在提供有关网络安全的内幕消息。
 🔸 [**TrustedSec**](https://www.trustedsec.com/category/articles/) - 有关网络安全的最新消息和趋势。
 🔸 [**PortSwigger Web 安全博客**](https://portswigger.net/blog)- 关于 Web 应用程序安全漏洞和来自我们 Web 安全团队的重要提示。
 🔸 [**AT&T 网络安全博客**](https://www.alienvault.com/blogs)- 有关新兴威胁的新闻和简化威胁检测的实用建议。
 🔸 [**Thhycotic**](https://thycotic.com/company/blog/) - 首席信息安全官和 IT 管理员来这里了解行业趋势、IT 安全等。

##### 极客网络安全播客

 🔸 [**Risky Business**](https://risky.biz/netcasts/risky-business/) - 是每周一次的信息安全播客，以新闻和深度访谈为特色。
 🔸 [**Cyber​​​​，由 Motherboard**](https://www.vice.com/en_us/topic/cyber) - 故事，并专注于有关网络安全的想法。
 🔸 [**Tenable Podcast**](https://www.tenable.com/podcast) - 与 Cyber​​ Exposure 等相关的对话和采访。
 🔸 [**Cyber​​crime Investigations**](https://podcasts.apple.com/gb/podcast/cybercrime-investigations/id1428801405) - Geoff White 关于网络犯罪的播客。
 🔸 [**many hats 俱乐部**](https://themanyhats.club/tag/episodes/)- 包含来自各种 Infosec 人员（Whitehat、Greyhat 和 Blackhat）的故事。
 🔸 [**暗网日记**](https://darknetdiaries.com/)- 来自互联网黑暗面的真实故事。
 🔸 [**OSINTCurious Webcasts**](https://www.youtube.com/playlist?list=PL423I_gHbWUXah3dmt_q_XNp0NlGAKjis) - 是帮助人们在 OSINT 中取得成功的调查好奇心。
 🔸 [**安全周刊**](https://www.youtube.com/user/SecurityWeeklyTV)- 最新的信息安全和黑客新闻。

##### 极客网络安全视频博客

 🔸 [**rev3rse 安全性**](https://www.youtube.com/channel/UCzvJStjySZVvOBsPl-Vgj0g)- 攻击性、二进制利用、Web 应用程序安全性、强化、红队、蓝队。
 🔸 [**LiveOverflow**](https://www.youtube.com/channel/UClcE-kVhqyiHCcjYwcpfj9w) - 比付费在线课程通常提供的更高级的主题 - 但免费。
 🔸 [**J4vv4D**](https://www.youtube.com/infoseccynic) - 关于我们互联网安全的重要信息。
 🔸 [**Cyber​​Talks**](https://cybertalks.co.uk/) - 关于网络安全的会谈、采访和文章。

##### 最佳个人推特账户

 🔸 [**@blackroomsec**](https://twitter.com/blackroomsec) - 白帽黑客/渗透测试者。1990 年星际扫雷冠军。
 🔸 [**@MarcoCiappelli**](https://twitter.com/MarcoCiappelli) - @ITSPmagazine 的联合创始人，位于 IT 安全与社会的交汇处。
 🔸 [**@binitamshah**](https://twitter.com/binitamshah) - Linux 布道者。恶意软件。内核开发。安全爱好者。
 🔸 [**@joe_carson**](https://twitter.com/joe_carson) - 信息安全专业和技术极客。
 🔸 [**@mikko**](https://twitter.com/mikko) - F-Secure 的 CRO，逆向工程师，TED 演讲者，Supervillain。
 🔸 [**@esrtweet**](https://twitter.com/esrtweet) - 通常被称为 ESR，是美国软件开发人员和开源软件倡导者。
 🔸 [**@gynvael**](https://twitter.com/gynvael) - 安全研究员/程序员，@DragonSectorCTF 创始人/玩家，技术主播。
 🔸 [**@x0rz**](https://twitter.com/x0rz) - 安全研究员和网络观察员。
 🔸 [**@hasherezade**](https://twitter.com/hasherezade) - 程序员，恶意软件分析师。PEbear、PEsieve、libPeConv 的作者。
 🔸 [**@TinkerSec**](https://twitter.com/TinkerSec) - 修补匠、密码朋克、黑客。
 🔸 [**@alisaesage**](https://twitter.com/alisaesage) - 独立的黑客和研究员。
 🔸 [**@SwiftOnSecurity**](https://twitter.com/SwiftOnSecurity) - 系统安全、工业安全、系统管理员、decentsecurity.com 的作者。
 🔸 [**@dakami**](https://twitter.com/dakami) - 是仅有的七个有权恢复 DNS 根密钥的人之一。
 🔸 [**@samykamkar**](https://twitter.com/samykamkar) - 是著名的“灰帽”黑客、安全研究员、MySpace“Samy”蠕虫的创建者。
 🔸 [**@securityweekly**](https://twitter.com/securityweekly) - Security Weekly 播客网络的创始人兼首席技术官。
 🔸 [**@jack_daniel**](https://twitter.com/jack_daniel) - @SecurityBSides 联合创始人。
 🔸 [**@thegrugq**](https://twitter.com/thegrugq) - 安全研究员。
 🔸 [**@matthew_d_green**](https://twitter.com/matthew_d_green) - 约翰霍普金斯大学的密码学家和教授。

##### 最佳商业 Twitter 帐户

 🔸 [**@haveibeenpwned**](https://twitter.com/haveibeenpwned) - 检查您的帐户是否因数据泄露而受到损害。
 🔸 [**@bugcrowd**](https://twitter.com/bugcrowd) - 比任何其他众包安全平台更受财富 500 强企业的信任。
 🔸 [**@Malwarebytes**](https://twitter.com/Malwarebytes) - 最值得信赖的安全公司。无与伦比的威胁可见性。
 🔸 [**@sansforensics**](https://twitter.com/sansforensics) - 世界领先的数字取证和事件响应提供商。
 🔸 [**@attcyber**](https://twitter.com/attcyber) - AT&T Cyber​​security 的边缘到边缘技术提供威胁情报等。
 🔸 [**@TheManyHatsClub**](https://twitter.com/TheManyHatsClub) - 一个专注于信息安全的播客和来自各行各业的一群人。
 🔸 [**@hedgehogsec**](https://twitter.com/hedgehogsec) - 刺猬网络。直布罗陀和曼彻斯特的顶级精品信息安全公司。
 🔸 [**@NCSC**](https://twitter.com/NCSC) - 国家网络安全中心。帮助使英国成为最安全的在线生活和工作场所。
 🔸 [**@Synacktiv**](https://twitter.com/Synacktiv) - IT 安全专家。

##### 一段历史

 🔸 [**How to Do Things at ARL**](http://web.archive.org/web/20190221103734/https://ftp.arl.army.mil/~mike/howto/) - 如何配置调制解调器、扫描图像、刻录 CD-ROM 等。*****

##### 其他

 🔸 [**Diffie-Hellman Key Exchange (short version)**](https://www.youtube.com/watch?v=3QnD2c4Xovk) - Diffie-Hellman Key Exchange 是如何工作的。

#### 黑客/渗透测试  [[TOC\]](https://github.com/trimstray/the-book-of-secret-knowledge#anger-table-of-contents)

##### Pentesters 武器库工具

 🔸 [**Sandcat Browser**](http://www.syhunt.com/sandcat/) - 一个面向渗透的浏览器，已经内置了许多高级功能。
 🔸 [**Metasploit**](https://www.metasploit.com/) - 用于渗透测试系统、Web 等的工具和框架，包含很多现成的漏洞利用。
 🔸 [**Burp Suite**](https://portswigger.net/burp) - 用于测试 Web 应用程序安全性、拦截代理以重放、注入、扫描和模糊测试的工具。
 🔸 [**OWASP Zed Attack Proxy**](https://www.owasp.org/index.php/OWASP_Zed_Attack_Proxy_Project) - 拦截代理以重放、注入、扫描和模糊 HTTP 请求。
 🔸 [**w3af**](http://w3af.org/) - 是一个 Web 应用程序攻击和审计框架。
 🔸 [**mitmproxy**](https://mitmproxy.org/) - 用于渗透测试人员的交互式 TLS 拦截 HTTP 代理。
 🔸 [**Nikto2**](https://cirt.net/Nikto2) - 网络服务器扫描仪，它针对多个项目对网络服务器执行全面测试。
 🔸 [**sqlmap**](http://sqlmap.org/) - 自动化检测和利用 SQL 注入漏洞的过程的工具。
 🔸 [**Recon-ng**](https://github.com/lanmaster53/recon-ng) - 是一个用 Python 编写的全功能 Web 侦察框架。
 🔸 [**AutoRecon**](https://github.com/Tib3rius/AutoRecon) - 是一种网络侦察工具，它执行服务的自动枚举。
 🔸 [**Faraday**](https://www.faradaysec.com/) - 一个集成的多用户渗透测试环境。
 🔸 [**Photon**](https://github.com/s0md3v/Photon) - 为 OSINT 设计的令人难以置信的快速爬虫。
 🔸 [**XSStrike**](https://github.com/s0md3v/XSStrike) - 最先进的 XSS 检测套件。
 🔸 [**Sn1per**](https://github.com/1N3/Sn1per) - 攻击性安全专家的自动化渗透测试框架。
 🔸 [**vuls**](https://github.com/future-architect/vuls) - 是适用于 Linux、FreeBSD 等的无代理漏洞扫描程序。
 🔸 [**tsunami**](https://github.com/google/tsunami-security-scanner) - 是具有可扩展插件系统的通用网络安全扫描器。
 🔸 [**aquatone**](https://github.com/michenriksen/aquatone) - 域天桥工具。
 🔸 [**BillCipher**](https://github.com/GitHackTools/BillCipher) - 网站或 IP 地址的信息收集工具。
 🔸 [**WhatWaf**](https://github.com/Ekultek/WhatWaf) - 检测和绕过 Web 应用程序防火墙和保护系统。
 🔸 [**Corsy -CORS**](https://github.com/s0md3v/Corsy)错误配置扫描器。
 🔸 [**Raccoon**](https://github.com/evyatarmeged/Raccoon) - 一种用于侦察和漏洞扫描的高性能攻击性安全工具。
 🔸 [**dirhunt**](https://github.com/Nekmo/dirhunt) - 查找没有暴力破解的 web 目录。
 🔸 [**John The Ripper**](https://www.openwall.com/john/) - 是一种快速密码破解程序，目前可用于多种 Unix、Windows 和其他版本。
 🔸 [**hashcat**](https://hashcat.net/hashcat/) - 世界上最快和最先进的密码恢复工具。
 🔸 [**p0f**](http://lcamtuf.coredump.cx/p0f3/) - 是一种用于识别任何偶然 TCP/IP 通信背后的参与者的工具。
 🔸 [**ssh_scan**](https://github.com/mozilla/ssh_scan) - 原型 SSH 配置和策略扫描器。
 🔸 [**LeakLooker**](https://github.com/woj-ciech/LeakLooker) - 查找开放数据库 - 由 Binaryedge.io 提供支持
 🔸 [**exploitdb**](https://github.com/offensive-security/exploitdb) - 来自 Exploit Database 的可搜索存档。
 🔸 [**getsploit**](https://github.com/vulnersCom/getsploit) - 是一个用于搜索和下载漏洞利用的命令行实用程序。
 🔸 [**ctf-tools**](https://github.com/zardus/ctf-tools) - 一些安全研究工具的设置脚本。
 🔸 [**pwntools**](https://github.com/Gallopsled/pwntools) - CTF 框架和漏洞利用开发库。
 🔸 [**security-tools**](https://github.com/bl4de/security-tools) - 主要在 Python 中创建的小型安全工具的集合。CTF、渗透测试等。
 🔸 [**pentestpackage**](https://github.com/leonteale/pentestpackage) - 是一个 Pentest 脚本包。
 🔸 [**python-pentest-tools**](https://github.com/dloss/python-pentest-tools) - 用于渗透测试人员的 python 工具。
 🔸 [**fuzzdb**](https://github.com/fuzzdb-project/fuzzdb) - 黑盒应用程序故障注入的攻击模式和原语字典。
 🔸 [**AFL**](https://github.com/google/AFL) - 是由 Google 维护的免费软件模糊器。
 🔸 [**AFL++**](https://github.com/AFLplusplus/AFLplusplus) - 是带有社区补丁的 AFL。
 🔸 [**syzkaller**](https://github.com/google/syzkaller) - 是一个无监督的、覆盖引导的内核模糊器。
 🔸 [**pwndbg**](https://github.com/pwndbg/pwndbg) - 利用 GDB 进行开发和逆向工程变得容易。
 🔸 [**GDB PEDA**](https://github.com/longld/peda) - GDB 的 Python Exploit 开发协助。
 🔸 [**IDA**](https://www.hex-rays.com/products/ida/index.shtml) - 用于逆向工程恶意软件的多处理器反汇编器和调试器。
 🔸 [**radare2**](https://github.com/radare/radare2) - 用于逆向工程和分析二进制文件的框架。
 🔸 [**routersploit**](https://github.com/threat9/routersploit) - 嵌入式设备的开发框架。
 🔸 [**Ghidra**](https://github.com/NationalSecurityAgency/ghidra) - 是一个软件逆向工程 (SRE) 框架。
 🔸 [**Cutter**](https://cutter.re/) - 是一个集成 Ghidra 反编译器的 SRE 平台。
 🔸 [**Vulnreport**](https://github.com/salesforce/vulnreport) - Salesforce Product Security 的开源渗透测试管理和自动化平台。
 🔸 [**Mentalist**](https://github.com/sc0tfree/mentalist) - 是用于自定义词表生成的图形工具。
 🔸 [**archerysec**](https://github.com/archerysec/archerysec) - 漏洞评估和管理有助于执行扫描和管理漏洞。
 🔸 [**Osmedeus**](https://github.com/j3ssie/Osmedeus) - 用于侦察和漏洞扫描的全自动攻击性安全工具。
 🔸 [**牛肉**](https://github.com/beefproject/beef)- 浏览器开发框架项目。
 🔸 [**AutoSploit**](https://github.com/NullArray/AutoSploit) - 自动化的大规模剥削者。
 🔸 [**SUDO_KILLER**](https://github.com/TH3xACE/SUDO_KILLER) - 是一种用于识别和利用 sudo 规则的错误配置和漏洞的工具。
 🔸 [**yara**](https://github.com/VirusTotal/yara) - 图案匹配瑞士刀。
 ...
 🔸 [**OWASP Threat Dragon**](https://owasp.org/www-project-threat-dragon/) - 是一种用于创建威胁模型图和记录可能威胁的工具。

##### Pentests 书签集合

 🔸 [**PTES**](http://www.pentest-standard.org/index.php/Main_Page) - 渗透测试执行标准。
 🔸 [**Pentests MindMap**](https://www.amanhardikar.com/mindmaps/Practice.html) - 带有易受攻击的应用程序和系统的惊人思维导图。
 🔸 [**WebApps Security Tests MindMap**](https://www.amanhardikar.com/mindmaps/webapptest.html) - 令人难以置信的 WebApps 安全测试思维导图。
 🔸 [**Brute XSS**](https://brutelogic.com.br/blog/) - 掌握跨站点脚本的艺术。
 🔸 [**XSS 备忘单**](https://portswigger.net/web-security/cross-site-scripting/cheat-sheet)- 包含许多可以帮助您绕过 WAF 和过滤器的向量。
 🔸 [**Offensive Security Bookmarks**](https://jivoi.github.io/2015/07/03/offensive-security-bookmarks/) - 安全书签集合，作者需要通过OSCP的所有东西。
 🔸 [**Awesome Pentest Cheat Sheets**](https://github.com/coreb1t/awesome-pentest-cheat-sheets) - 对渗透测试有用的备忘单集合。
 🔸 [**HackWithGithub 的 Awesome Hacking**](https://github.com/Hack-with-Github/Awesome-Hacking) - 黑客、渗透测试者和安全研究人员的精彩列表。
 🔸 [**由 carpedm20**](https://github.com/carpedm20/awesome-hacking)提供的 Awesome Hacking - 精选的黑客教程、工具和资源列表。
 🔸 [**Awesome Hacking Resources**](https://github.com/vitalysim/Awesome-Hacking-Resources) - 收集黑客/渗透测试资源，让您变得更好。
 🔸 [**Awesome Pentest**](https://github.com/enaqx/awesome-pentest) - 收集了很棒的渗透测试资源、工具和其他闪亮的东西。
 🔸 [**Awesome-Hacking-Tools**](https://github.com/m4ll0k/Awesome-Hacking-Tools) - 是一个精选的黑客工具列表。
 🔸 [**Hacking Cheat Sheet**](https://github.com/ksanchezcld/Hacking_Cheat_Sheet) - 作者 hacking 和 pentesting 笔记。
 🔸 [**blackhat-arsenal-tools**](https://github.com/toolswatch/blackhat-arsenal-tools) - 官方 Black Hat 武器库安全工具库。
 🔸 [**渗透测试和 WebApp**](https://www.peerlyst.com/posts/the-complete-list-of-infosec-related-cheat-sheets-claus-cramon)备忘单 - Infosec 相关备忘单的完整列表。
 🔸 [**网络安全资源**](https://github.com/The-Art-of-Hacking/h4cker)- 包括数以千计的网络安全相关参考资料和资源。
 🔸 [**渗透测试书签**](https://github.com/jhaddix/pentest-bookmarks)- 有很多渗透测试的博客。
 🔸 [**Cheatsheet-God**](https://github.com/OlivierLaflamme/Cheatsheet-God) - 渗透测试参考库 - OSCP/PTP & PTX Cheatsheet。
 🔸 [**ThreatHunter-Playbook**](https://github.com/Cyb3rWard0g/ThreatHunter-Playbook) - 帮助开发狩猎活动的技术和假设。
 🔸 [**Beginner-Network-Pentesting**](https://github.com/hmaverickadams/Beginner-Network-Pentesting) - 初学者网络渗透测试课程的笔记。
 🔸 [**OSCPRepo**](https://github.com/rewardone/OSCPRepo) - 是作者为准备 OSCP 而收集的资源列表。
 🔸 [**PayloadsAllTheThings**](https://github.com/swisskyrepo/PayloadsAllTheThings) - Web 应用程序安全和 Pentest/CTF 的有用负载和绕过列表。
 🔸 [**有效载荷**](https://github.com/foospidy/payloads)- git 所有有效载荷！Web 攻击有效载荷的集合。
 🔸 [**command-injection-payload-list**](https://github.com/payloadbox/command-injection-payload-list) - 命令注入有效负载列表。
 🔸 [**Awesome Shodan Search Queries**](https://github.com/jakejarvis/awesome-shodan-queries) - 插入 Shodan 的出色搜索查询。
 🔸 [**AwesomeXSS**](https://github.com/s0md3v/AwesomeXSS) - 是 Awesome XSS 资源的集合。
 🔸 [**php-webshel​​ls**](https://github.com/JohnTroony/php-webshells) - 常见的 php webshel​​ls。
 🔸 [**Pentesting Tools Cheat Sheet**](https://highon.coffee/blog/penetration-testing-tools-cheat-sheet/) - 典型渗透测试的快速参考高级概述。
 🔸 [**OWASP 备忘单系列**](https://cheatsheetseries.owasp.org/)- 是有关特定应用程序安全主题的高价值信息的集合。
 🔸 [**OWASP 依赖检查**](https://jeremylong.github.io/DependencyCheck/index.html)- 是 OWASP Top 10 2013 条目的开源解决方案。
 🔸 [**OWASP ProActive Controls**](https://www.owasp.org/index.php/OWASP_Proactive_Controls) - OWASP Top 10 Proactive Controls 2018.
 🔸 [**PENTESTING-BIBLE**](https://github.com/blaCCkHatHacEEkr/PENTESTING-BIBLE) - 黑客和渗透测试以及红队和网络安全资源。
 🔸 [**pentest-wiki**](https://github.com/nixawk/pentest-wiki) - 是一个免费的在线安全知识库，供渗透测试人员/研究人员使用。
 🔸 [**DEF CON 媒体服务器**](https://media.defcon.org/)- 来自 DEFCON 的好东西。
 🔸 [**Awesome Malware Analysis**](https://github.com/rshipp/awesome-malware-analysis) - 精选的恶意软件分析工具和资源列表。
 🔸 [**SQL Injection Cheat Sheet**](https://www.netsparker.com/blog/web-security/sql-injection-cheat-sheet/) - 有关 SQL 注入的许多不同变体的详细技术资料。
 🔸 [**Entersoft 知识库**](http://kb.entersoft.co.in/)- 关于漏洞的详细详细参考。
 🔸 [**HTML5 Security Cheatsheet**](http://html5sec.org/) - HTML5 相关 XSS 攻击向量的集合。
 🔸 [**XSS 字符串编码器**](http://evuln.com/tools/xss-encoder/)- 用于生成 XSS 代码以针对 XSS 检查您的输入验证过滤器。
 🔸 [**GTFOBins**](https://gtfobins.github.io/) - 可被攻击者利用以绕过本地安全限制的 Unix 二进制文件列表。
 🔸 [**Guifre Ruiz Notes**](https://guif.re/) - 收集安全、系统、网络和渗透测试的备忘单。
 🔸 [**SSRF Tips**](http://blog.safebuff.com/2016/07/03/SSRF-Tips/index.html) - SSRF Tips 的集合。
 🔸 [**shell-storm repo CTF**](http://shell-storm.org/repo/CTF/) - 很棒的 CTF 档案。
 🔸 [**ctf**](https://github.com/bl4de/ctf) - CTF（夺旗）文章、代码片段、注释、脚本。
 🔸 [**My-CTF-Web-Challenges**](https://github.com/orangetw/My-CTF-Web-Challenges) - CTF Web 挑战的集合。
 🔸 [**MSTG**](https://github.com/OWASP/owasp-mstg) - 移动安全测试指南 (MSTG) 是移动应用安全测试的综合手册。
 🔸 [**Internal-Pentest-Playbook**](https://github.com/sdcampbell/Internal-Pentest-Playbook) - 内部网络渗透测试最常见的注意事项。
 🔸 [**KeyHacks**](https://github.com/streaak/keyhacks) - 显示可以检查错误赏金计划泄露的 API 密钥的快速方法。
 🔸 [**securitum/research**](https://github.com/securitum/research) - Securitum 执行的各种安全研究概念证明。
 🔸 [**public-pentesting-reports**](https://github.com/juliocesarfort/public-pentesting-reports) - 是几个咨询安全组织发布的公共渗透测试报告列表。
 🔸 [**awesome-bug-bounty**](https://github.com/djadmin/awesome-bug-bounty) - 是一个全面的可用 Bug Bounty 列表。
 🔸 [**bug-bounty-reference**](https://github.com/ngalongc/bug-bounty-reference) - 是一个 bug 赏金列表。
 🔸 [**Awesome-Bugbounty-Writeups**](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups) - 是一个精选的 bugbounty 文章列表。
 🔸 [**Bug bounty writeups**](https://pentester.land/list-of-bug-bounty-writeups.html) - Bug bounty writeups 列表（2012-2020）。
 🔸 [**hackso.me**](https://hackso.me/) - 安全之旅。

##### 后门/漏洞

 🔸 [**PHP-backdoors**](https://github.com/bartblaze/PHP-backdoors) - PHP 后门的集合。仅用于教育或测试目的。

##### 词汇表和弱密码

 🔸 [**Weakpass**](https://weakpass.com/) - 对于任何类型的蛮力查找单词表或一次释放它们的力量！
 🔸 [**Hashes.org**](https://hashes.org/) - 是一个免费的在线哈希解析服务，结合了许多无与伦比的技术。
 🔸 [**SecLists**](https://github.com/danielmiessler/SecLists) - 安全评估期间使用的多种类型列表的集合，收集在一个地方。
 🔸 [**Probable-Wordlists**](https://github.com/berzerk0/Probable-Wordlists) - 按最初为密码生成和测试创建的概率排序。
 🔸 [**头骨安全密码**](https://wiki.skullsecurity.org/index.php?title=Passwords)- 密码字典和泄露的密码存储库。
 🔸 [**波兰语高级词典**](https://bezpieka.org/polski-slownik-premium-polish-wordlist)- 由团队在 bezpieka.org 论坛上创建的官方词典。***** [1](https://sourceforge.net/projects/kali-linux/files/Wordlist/)[
 🔸 ](https://sourceforge.net/projects/kali-linux/files/Wordlist/)[**统计上可能的用户名**](https://github.com/insidetrust/statistically-likely-usernames)- 用于创建统计上可能的用户名列表的单词列表。

##### 赏金平台

 🔸 [**YesWeHack**](https://www.yeswehack.com/) - 具有信息安全工作的漏洞赏金平台。
 🔸 [**Openbugbounty**](https://www.openbugbounty.org/) - 允许任何安全研究人员在任何网站上报告漏洞。
 🔸 [**hackerone**](https://www.hackerone.com/) - 全球黑客社区，用于揭示最相关的安全问题。
 🔸 [**bugcrowd**](https://www.bugcrowd.com/) - 企业的众包网络安全。
 🔸 [**Crowdshield**](https://crowdshield.com/) - 众包安全和漏洞奖励管理。
 🔸 [**Synack**](https://www.synack.com/) - 众包安全和漏洞赏金计划、众包安全情报平台等。
 🔸 [**Hacktrophy**](https://hacktrophy.com/en/) - 漏洞赏金平台。

##### 网络培训应用程序（本地安装）

 🔸 [**OWASP-VWAD**](https://www.owasp.org/index.php/OWASP_Vulnerable_Web_Applications_Directory_Project) - 所有已知易受攻击的 Web 应用程序的全面且维护良好的注册表。
 🔸 [**DVWA**](http://www.dvwa.co.uk/) - 该死的易受攻击的 PHP/MySQL Web 应用程序。
 🔸 [**metasploitable2**](https://metasploit.help.rapid7.com/docs/metasploitable-2) - 安全研究人员中易受攻击的 Web 应用程序。
 🔸 [**metasploitable3**](https://github.com/rapid7/metasploitable3) - 是一个从头开始构建的具有大量安全漏洞的虚拟机。
 🔸 [**DSVW**](https://github.com/stamparm/DSVW) - 是一个故意易受攻击的 Web 应用程序，用不到 100 行代码编写。
 🔸 [**OWASP Mutillidae II**](https://sourceforge.net/projects/mutillidae/) - 免费、开源、故意易受攻击的 Web 应用程序。
 🔸 [**OWASP Juice Shop Project**](https://www.owasp.org/index.php/OWASP_Juice_Shop_Project) - 现存最无漏洞的易受攻击的应用程序。
 🔸 [**OWASP Node js Goat Project**](https://www.owasp.org/index.php/Projects/OWASP_Node_js_Goat_Project) - OWASP 十大安全风险适用于使用 Node.js 开发的 Web 应用程序。
 🔸 [**juicy-ctf**](https://github.com/iteratec/juicy-ctf) - 使用 OWASP Juice Shop 运行 Capture the Flags 和安全培训。
 🔸 [**SecurityShepherd**](https://github.com/OWASP/SecurityShepherd) - 网络和移动应用安全培训平台。
 🔸 [**Security Ninjas**](https://github.com/opendns/Security_Ninjas_AppSec_Training) - 开源应用程序安全培训计划。
 🔸 [**hackazon**](https://github.com/rapid7/hackazon) - 一个现代易受攻击的网络应用程序。
 🔸 [**dvna**](https://github.com/appsecco/dvna) - 该死的易受攻击的 NodeJS 应用程序。
 🔸 [**django-DefectDojo**](https://github.com/DefectDojo/django-DefectDojo) - 是一个开源应用程序漏洞关联和安全编排工具。
 🔸 [**Google Gruyere**](https://google-gruyere.appspot.com/) - Web 应用程序漏洞利用和防御。
 🔸 [**Bodhi**](https://github.com/amolnaik4/bodhi) - 是一个专注于学习利用客户端 Web 漏洞的游乐场。
 🔸 [**Websploit**](https://websploit.h4cker.org/) - 单个 vm 实验室，旨在将多个易受攻击的应用程序组合在一个环境中。
 🔸 [**vulhub**](https://github.com/vulhub/vulhub) - 基于 docker-compose 的预构建易受攻击环境。
 🔸 [**CloudGoat 2**](https://rhinosecuritylabs.com/aws/introducing-cloudgoat-2/) - 新的和改进的“设计漏洞”AWS 部署工具。
 🔸 [**secDevLabs**](https://github.com/globocom/secDevLabs) - 是一个以实用方式学习安全 Web 开发的实验室。
 🔸 [**CORS-vulnerable-Lab**](https://github.com/incredibleindishell/CORS-vulnerable-Lab) - 易受攻击的代码及其漏洞利用代码示例。
 🔸 [**RootTheBox**](https://github.com/moloch--/RootTheBox) - 黑客游戏（CTF 记分牌和游戏管理器）。
 🔸 [**KONTRA**](https://application.security/) - 应用程序安全培训（OWASP Top Web & Api）。

##### 实验室（道德黑客平台/培训/CTF）

 🔸 [**Offensive Security**](https://www.offensive-security.com/) - 十多年来真正基于性能的渗透测试培训。
 🔸 [**Hack The Box**](https://www.hackthebox.eu/) - 在线平台，让您测试您的渗透测试技能。
 🔸 [**Hacking-Lab**](https://www.hacking-lab.com/index.html) - 在线道德黑客、计算机网络和安全挑战平台。
 🔸 [**pwnable.kr**](http://pwnable.kr/index.php) - 提供各种 pwn 挑战的非商业战争游戏网站。
 🔸 [**Pwnable.tw**](https://pwnable.tw/) - 是一个战争游戏网站，供黑客测试和扩展他们的二进制利用技能。
 🔸 [**picoCTF**](https://picoctf.com/) - 是一款针对中学生的免费电脑安全游戏。
 🔸 [**CTFlearn**](https://ctflearn.com/) - 是一个在线平台，旨在帮助道德黑客学习和实践他们的网络安全知识。
 🔸 [**ctftime**](https://ctftime.org/) - CTF 存档和一个地方，您可以在其中获得一些其他与 CTF 相关的信息。
 🔸 [**Silesia Security Lab**](https://silesiasecuritylab.com/) - 高质量的安全测试服务。
 🔸 [**Practical Pentest Labs**](https://practicalpentestlabs.com/) - pentest 实验室，让您的黑客技能更上一层楼。
 🔸 [**Root Me**](https://www.root-me.org/?lang=en) - 训练您的黑客技能的快速、简单且经济实惠的方式。
 🔸 [**rozwal.to**](https://rozwal.to/login) - 一个训练您的渗透技能的绝佳平台。
 🔸 [**TryHackMe**](https://tryhackme.com/) - 轻松学习网络安全。
 🔸 [**hackxor**](https://hackxor.net/) - 是一款逼真的网络应用程序黑客游戏，旨在帮助各种能力的玩家发展他们的技能。
 🔸 [**首先破解自己**](http://hack-yourself-first.com/)- 它充满了令人讨厌的应用程序漏洞。
 🔸 [**OverTheWire**](http://overthewire.org/wargames/) - 可以帮助您以充满乐趣的游戏形式学习和练习安全概念。
 🔸 [**Wizard Labs**](https://labs.wizard-security.net/) - 是一个在线渗透测试实验室。
 🔸 [**PentesterLab**](https://pentesterlab.com/) - 提供可用于测试和理解漏洞的易受攻击的系统。
 🔸 [**RingZer0**](https://ringzer0ctf.com/) - 旨在测试和提高您的黑客技能的大量挑战。
 🔸 [**try2hack**](http://www.try2hack.nl/) - 几个面向安全的娱乐挑战。
 🔸 [**Ubeeri**](https://www.ubeeri.com/preconfig-labs) - 预配置的实验室环境。
 🔸 [**Pentestit**](https://lab.pentestit.ru/) - 模拟真实公司的 IT 基础设施，以进行合法的渗透测试和提高渗透测试技能。
 🔸 [**微腐败**](https://microcorruption.com/login)- 在 Web 界面中完成的逆转挑战。
 🔸 [**Crackmes**](https://crackmes.one/) - 下载crackmes以帮助提高您的逆向工程技能。
 🔸 [**DomGoat**](https://domgo.at/cxss/intro) - DOM XSS 安全学习和实践平台。
 🔸 [**刻板印象的挑战**](https://chall.stypr.com/)- 立即升级您的网络黑客技术！
 🔸 [**Vulnhub**](https://www.vulnhub.com/) - 允许任何人获得数字安全方面的实际“动手”经验。
 🔸 [**W3Challs**](https://w3challs.com/) - 是一个渗透测试培训平台，提供各种计算机挑战。
 🔸 [**RingZer0 CTF**](https://ringzer0ctf.com/challenges) - 为您提供大量旨在测试和提高黑客技能的挑战。
 🔸 [**Hack.me**](https://hack.me/) - 一个平台，您可以在其中构建、托管和共享易受攻击的 Web 应用程序以用于教育目的。
 🔸 [**哈克这个！**](https://www.hackthis.co.uk/levels/)- 了解如何进行黑客攻击、转储和破坏并保护您的网站。
 🔸 [**Enigma Group WebApp Training**](https://www.enigmagroup.org/#) - 这些挑战涵盖了 OWASP Top 10 项目中列出的漏洞。
 🔸 [**逆向工程挑战**](https://challenges.re/)- 挑战、练习、问题和任务 - 按级别、按类型等。
 🔸 [**0x00sec**](https://0x00sec.org/) - 黑客之家 - 恶意软件、逆向工程和计算机科学。
 🔸 [**我们**](https://www.wechall.net/challs)挑战 - 存在许多不同的挑战类型。
 🔸 [**Hacker Gateway**](https://www.hackergateway.com/) - 是想要测试其技能的黑客的首选之地。
 🔸 [**Hacker101**](https://www.hacker101.com/) - 是一个免费的网络安全课程。
 🔸 contains.af - 一个用于学习容器、功能和系统调用的愚蠢游戏[**。**](https://contained.af/)
 🔸 [**挑战！**](http://flaws.cloud/)- 一系列级别，您将了解使用 AWS 时的常见错误和陷阱。
 🔸 [**Cyber​​Sec WTF**](https://cybersecurity.wtf/) - 提供来自赏金文章的网络黑客挑战。
 🔸 [**CTF 挑战**](https://ctfchallenge.co.uk/login)- CTF Web 应用挑战。
 🔸 [**gCTF**](https://capturetheflag.withgoogle.com/) - Google CTF 2017 中使用的大多数挑战。
 🔸 [**Hack This Site**](https://www.hackthissite.org/pages/index/index.php) - 是一个免费、安全和合法的黑客培训基地。
 🔸 [**Attack & Defense**](https://attackdefense.com/) - 是一个基于浏览器的云实验室。
 🔸 [**Cryptohack**](https://cryptohack.org/) - 一个学习现代密码学的有趣平台。
 🔸 [**Cryptopals**](https://cryptopals.com/) - cryptopals 加密挑战。

##### CTF 平台

 🔸 [**fbctf**](https://github.com/facebook/fbctf) - 举办夺旗比赛的平台。
 🔸 [**ctfscoreboard**](https://github.com/google/ctfscoreboard) - 夺旗比赛的记分牌。

##### 其他资源

 🔸 [**Bugcrowd University**](https://github.com/bugcrowd/bugcrowd_university) - 面向研究人员社区的开源教育内容。
 🔸 [**OSCPRepo**](https://github.com/rewardone/OSCPRepo) - 我为准备 OSCP 收集的资源和脚本列表。
 🔸 [**OWASP 前 10 名：真实示例**](https://medium.com/@cxosmo/owasp-top-10-real-world-examples-part-1-a540c4ea2df5)- 使用真实示例测试您的 Web 应用程序（两部分系列）。
 🔸 [**phrack.org**](http://phrack.org/index.html) - 来自几位受人尊敬的黑客和其他思想家的精彩文章集合。
 🔸 [**Practical-Ethical-Hacking-Resources**](https://github.com/Gr1mmie/Practical-Ethical-Hacking-Resources) - 来自 TCM 的 Udemy 课程的资源汇编。

#### 您的日常知识和新闻  [[TOC\]](https://github.com/trimstray/the-book-of-secret-knowledge#anger-table-of-contents)

##### RSS 阅读器

 🔸 [**Feedly**](https://feedly.com/) - 组织、阅读和分享对您而言重要的内容。
 🔸 [**Inoreader**](https://www.inoreader.com/) - 类似于 feedly，支持过滤从 rss 获取的内容。

##### IRC 频道

 🔸 [**#hackerspaces**](https://wiki.hackerspaces.org/IRC_Channel) - 黑客空间 IRC 频道。

##### 安全

 🔸 [**黑客新闻**](https://thehackernews.com/)- 致力于提高安全专家和黑客意识的领先新闻来源。
 🔸 [**最新黑客新闻**](https://latesthackingnews.com/)- 为道德黑客提供最新的黑客新闻、漏洞利用和漏洞。
 🔸 [**Security Newsletter**](https://securitynewsletter.co/) - 每周摘要形式的安全新闻（电子邮件通知）。
 🔸 [**谷歌在线安全博客**](https://security.googleblog.com/)- 谷歌关于互联网安全的最新消息和见解。
 🔸 [**Qualys 博客**](https://blog.qualys.com/)- 专家网络安全指导和新闻。
 🔸 [**DARKReading**](https://www.darkreading.com/) - 连接信息安全社区。
 🔸 [**暗网**](https://www.darknet.org.uk/)- 最新的黑客工具、黑客新闻、网络安全最佳实践、道德黑客和渗透测试。
 🔸 [**公开**](https://twitter.com/disclosedh1)披露 - 公开披露观察者，可让您及时了解最近披露的错误。
 🔸 [**Reddit - 黑客**](https://www.reddit.com/r/hacking/)- 一个专门针对黑客和黑客的 subreddit。
 🔸 [**Packet Storm**](https://packetstormsecurity.com/) - 信息安全服务、新闻、文件、工具、漏洞利用、咨询和白皮书。
 🔸 [**Sekurak**](https://sekurak.pl/) - 关于安全、渗透测试、漏洞和许多其他 (PL/EN)。
 🔸 [**nf.sec**](https://nfsec.pl/) - Linux 操作系统安全 (PL) 的基本方面和机制。

##### 其他/一体机

 🔸 [**Changelog**](https://changelog.com/) - 是一个黑客社区；面向开发人员和黑客的新闻和播客。

#### 其他备忘单  [[TOC\]](https://github.com/trimstray/the-book-of-secret-knowledge#anger-table-of-contents)

###### 建立自己的 DNS 服务器

 🔸 [**Unbound DNS Tutorial**](https://calomel.org/unbound_dns.html) - 一个验证、递归和缓存的 DNS 服务器。
 🔸 [**Fedora 上的 Knot Resolver**](https://www.ctrl.blog/entry/knot-dns-resolver-tutorial.html) - 如何使用 Fedora 上的 Knot Resolver 获得更快、更安全的 DNS 解析。
 🔸 [**DNS-over-HTTPS**](https://www.aaflalo.me/2018/10/tutorial-setup-dns-over-https-server/) - 设置您自己的 DNS-over-HTTPS (DoH) 服务器的教程。
 🔸 [**dns-over-https**](https://hacks.mozilla.org/2018/05/a-cartoon-intro-to-dns-over-https/) - 通过 HTTPS 对 DNS 的卡通介绍。
 🔸 [**DNS-over-TLS**](https://www.aaflalo.me/2019/03/dns-over-tls/) - 在您的 DoH 服务器之后，设置您的 DNS-over-TLS (DoT) 服务器。
 🔸 [**DNS 服务器**](https://zwischenzugs.com/2018/01/26/how-and-why-i-run-my-own-dns-servers/)- 我如何（以及为什么）运行我自己的 DNS 服务器。

###### 建立自己的证书颁发机构

 🔸 [**OpenSSL 证书颁发机构**](https://jamielinux.com/docs/openssl-certificate-authority/)- 使用 OpenSSL 工具构建您自己的证书颁发机构 (CA)。
 🔸 [**step-ca 证书颁发机构**](https://github.com/smallstep/certificates)- 使用开源 step-ca 构建您自己的证书颁发机构 (CA)。

###### 构建自己的系统/虚拟机

 🔸 [**os-tutorial**](https://github.com/cfenollosa/os-tutorial) - 如何从头开始创建操作系统。
 🔸 [**编写您自己的虚拟机**](https://justinmeiners.github.io/lc3-vm/)- 如何编写您自己的虚拟机 (VM)。
 🔸 [**x86 Bare Metal Examples**](https://github.com/cirosantilli/x86-bare-metal-examples) - 几十个最小的操作系统来学习 x86 系统编程。
 🔸 [**simple-computer**](https://github.com/djhworld/simple-computer) - 来自“但它怎么知道？”的 scott CPU J.克拉克斯科特。
 🔸 [**littleosbook**](https://littleosbook.github.io/) - 关于操作系统开发的小书。
