...
![仅截取部分内容](https://s2.loli.net/2022/04/11/Q75MpaCmVcs4Fq2.png)
...
![http://image.iswbm.com/image-20200312201759541.png](https://s2.loli.net/2022/04/11/9oNaETdOxfZJWHl.png)

当然，你也可以不指定，此时生成的可执行文件是以 文件夹名命名

![http://image.iswbm.com/image-20200312202032363.png](https://s2.loli.net/2022/04/11/fqOo4CvUHtgY3Dd.png)

当然你也可以手动指定这个可执行文件名

![http://image.iswbm.com/image-20200312202520902.png](https://s2.loli.net/2022/04/11/AjbUTZBsMHqVOzJ.png)
...
![http://image.iswbm.com/image-20200313224148510.png](https://s2.loli.net/2022/04/11/J4fLr68FeHacoku.png)
...
![image-20200312203244402](https://s2.loli.net/2022/04/11/vq5dHtzcpanlX7N.png)
...
![http://image.iswbm.com/image-20200312204335687.png](https://s2.loli.net/2022/04/11/posJi2hOxaCGlbK.png)

由于此时，我们已经下载了 logging 包，当你再次执行 go get 时，并不会重复下载，只有当你指定 `-u` 时，不管你需不需要更新，都会触发重新下载强制更新。

![http://image.iswbm.com/image-20200312204746007.png](https://s2.loli.net/2022/04/11/wj2vqo7XkBc8snD.png)

如果你想看，下载这个过程用到了哪几个命令，可以指定 `-x` 参数

![http://image.iswbm.com/image-20200312205001161.png](https://s2.loli.net/2022/04/11/TkpuOKfDxzj7Bha.png)

最后，你可能想说，为什么 golang 里的包含这么长，好难记呀，其实这个路径是有讲究的

![http://image.iswbm.com/image-20200312210557326.png](https://s2.loli.net/2022/04/11/vZCF5lno7hU8KHM.png)
...
![http://image.iswbm.com/image-20200312221011685.png](https://s2.loli.net/2022/04/11/JiPjYyK97QGM2U6.png)

如果你安装的是一个库，它会将这个库安装到 pkg 目录下，生成 `.a` 为后缀的文件。

![http://image.iswbm.com/image-20200312221141028.png](https://s2.loli.net/2022/04/11/mUeNsdGf4u6KDqX.png)
